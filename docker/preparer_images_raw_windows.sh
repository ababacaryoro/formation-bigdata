...
#  coût ponctuel, à payer une seule.
#
...
docker build --platform "$PLATEFORME" \
    -f ./Dockerfile -t formation-jupyter:1.0 .
...
echo "  1. Lancer le test hors ligne :   ./scripts/tester_hors_ligne.sh"
